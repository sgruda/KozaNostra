...
public @Data class AccountDTO {
    ...
    public AccountDTO(Long id, String login, String password, boolean active, boolean confirmed, String firstname, String lastname, String email, String veryficationToken) {
        this.id = id;
        this.login = login;
